...
My research focuses on understanding how social, behavioral, and biological factors jointly shape mental and physical health, and on developing methods that make these relationships more interpretable, scalable, and clinically meaningful. I work with large-scale biomedical cohorts such as UK Biobank and ABCD, using high-dimensional mediation, multimodal prediction, and multilayer hypergraph modeling to integrate neuroimaging, electronic health records, mobile sensing, genetic, and social-environmental data.
